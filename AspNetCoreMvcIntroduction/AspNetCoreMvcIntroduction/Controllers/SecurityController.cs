...
using AspNetCoreMvcIntroduction.Models.Security;
...
namespace AspNetCoreMvcIntroduction.Controllers
{
    public class SecurityController : Controller
    {
        ...
        {
            if (!ModelState.IsValid) // DATA ANN kısmını kontrol eder.
            {
            ...
            if (user != null)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Confirm ");
                    return View(loginViewModel);
                }
            }
        ...
        public async Task<IActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            return RedirectToAction("Index", "Studet");
