...
namespace Demo.Tests
{
    ...
    /*
     Testte gereksinimlri belirleyip testi yazıp property ve classları oluşturduk
    ve testi run edip RED ulaştık ilk evre bitti

    Gruplayıcıda testi geçebilecek en basit kodu yazdık ve green evresi bitti


    Refactoring evresine test method ismini değiştirerek başladık ve gereksinimleri kodlayarak refactor edip başka örnekler için de denedik
    ...
    public class GruplayiciTests
    {
        ...
        {//testhata verdi şimdi bütün testi geçecek en basit kodu yazmalıyım
